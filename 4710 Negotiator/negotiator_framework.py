...
from negotiator_submission import NegotiatorSubmission
from jackass_negotiator import JackassNegotiator
from jackass_negotiator2 import JackassNegotiator2
from nice_guy import NiceGuy
...
if __name__ == "__main__":
    ...
    # negotiator_a = JackassNegotiator2()
    negotiator_a = NiceGuy()
    negotiator_b = NegotiatorSubmission()
    for x in range(0,10):
